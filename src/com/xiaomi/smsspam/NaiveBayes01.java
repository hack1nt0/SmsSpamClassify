...
public class NaiveBayes01 {
    ...
    public boolean classify(Corpus cps)
    {
        ...
        for(int cIndex = 0; cIndex < CLASS_COUNT; ++cIndex)
        {
            ...
            for(int i = 0; i < rmgr.getRuleCnt(); ++i)
            {
    ...
    public void saveModel() throws IOException
    {
      ...
      int ruleNumber = rmgr.getRuleCnt();
      ...
      dataOut.writeInt(rmgr.getRuleObjs().length);
      for(int i = 0; i < rmgr.getRuleObjs().length; i++)
      {
        dataOut.writeChars(rmgr.getRuleObjs()[i].getName()+"\n");
        rmgr.getRuleObjs()[i].writeDef(dataOut);
      }
        /*
    ...
    {/*
        ...
        ruleManager = new RuleManager(rp,ru);
        ruleManager.initPreRules();
