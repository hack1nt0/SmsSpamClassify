...
import com.ansj.word2vec.domain.HiddenNeuron;
import com.ansj.word2vec.domain.Neuron;
import com.ansj.word2vec.domain.WordNeuron;
import com.ansj.word2vec.util.Haffman;
...
public class Learn {
    ...
    private void readVocab(File file) throws IOException {
        ...
        for (Entry<String, Double> element : mc.get().entrySet()) {
            wordMap.put(element.getKey(), new WordNeuron(element.getKey(), element.getValue().intValue(),
                layerSize));
        }
    }
